...
import EditEducationalDetails from "./editEducationalDetails";
  ...
  return (
    <div className="flex flex-row m-3 justify-between w-full h-[710px] overflow--hidden">
      ...
      <div className="w-80 p-6 border-2 ">
        ...
        <div className="mt-8">
         <div className="flex"> <h1 className="text-md font-semibold">Experiance</h1>
         <i class="ri-pencil-line font-extrabold text-blue-700 ml-2"></i></div>
          <p className="text-base text-gray-400">4 years</p>
        </div>
        <div className="mt-8">
        <div className="flex"> <h1 className="text-md font-semibold">Education</h1>
         <i class="ri-pencil-line font-extrabold text-blue-700 ml-2"></i></div>
          <p className="text-base text-gray-400">Bachelor in Graphic Design </p>
        </div>
        <div className="mt-8">
        <div className="flex"> <h1 className="text-md font-semibold">Info</h1>
         <i class="ri-pencil-line font-extrabold text-blue-700 ml-2"></i></div>
