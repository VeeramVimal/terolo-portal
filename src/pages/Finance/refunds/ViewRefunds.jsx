        ...
        <div className="add-business md:m-3 m-0">
            ...
            <div className="  lg:w-full lg:flex-row sm:w-full sm:flex-row flex flex-col w-full">
                <div className=" lg:w-1/3 sm:w-2/5 w-full border border-bordercolor h-screen">
                    <h1 className="font-bold text-[18px] p-2 py-3 pl-5"> Refunds</h1>
                    <div className='pl-5'>
            ...
            >
              ...
              <p className='text-[14px] py-3 text-[#22314F]'>Bigdata project - Milestone 4 Esclation due to failed to finish within deadline.</p>
              </div>
              ...
              <p className='text-[14px] py-3 text-[#22314F]'>₹ 10,000,000.00</p>
              </div>
              <div className='pb-5'>
              ...
              <p className='text-[14px] py-3 text-[#22314F]'>Card</p>
              </div>
              </div>
