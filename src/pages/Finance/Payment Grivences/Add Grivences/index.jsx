...
import { addGrievancesSchema } from "../../../../schemas";
import { useDispatch } from "react-redux";
import { addRecord, fileUploadApi } from "../paymentgrievances.action";
...
const AddGrivences = ({ setOpen }) => {
  ...
  const {
    ...
    validationSchema: addGrievancesSchema,
    onSubmit: (values) => {
    },
  });
