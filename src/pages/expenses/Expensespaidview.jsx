  ...
  return (
    ...
    <SideDrawer
      ...
      <div className="w-3/12 p-4 border-2 ">
        ...
        <div className='mb-2'><h4 className='flex items-center font-semibold text-lg m-0 not-italic'>Invoice(if already paid)</h4>
            <Button type="dashed">Great!
...
export default Expensespaidview;